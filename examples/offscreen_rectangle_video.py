...
from animanode.rectangle import setup_drawing_sync
...
if __name__ == "__main__":
    # Create HD video with rectangle
    create_video("rectangle.mp4", width=1280, height=960, fps=60, duration=5.0, quality=9)
