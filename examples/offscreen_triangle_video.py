...
from animanode.triangle import setup_drawing_sync
...
if __name__ == "__main__":
    # Create HD video with triangle
    create_video("triangle.mp4", width=1280, height=960, fps=60, duration=5.0, quality=9)
